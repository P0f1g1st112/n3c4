...
* [`src/cljs/grump2/`](src/cljs/grump2/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/grump2/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `grump2` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/grump2/config.cljs) defaults to `true` in
...
```clj
(ns grump2.example
  (:require [grump2.config :as config])
